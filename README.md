...
https://www.kaggle.com/datasets/manahilsiddique/parkinsons-imu-tremor-severity-dataset. Change the file path in the XAI_CNN_COMPLETE.py paths to your own directory. Install the requirements .txt and run the command 
